...
* `Sharp` is a depth enhanced local contrast sharpen filter. Inspired by Radeon Image Sharpening. Yet hardware an API agnostic thanks to the power of Reshade.
